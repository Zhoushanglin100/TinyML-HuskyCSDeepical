...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "iegm_net_sf1bz256lr0_01"
...
#define AI_NETWORK_IN_1_HEIGHT      (1250)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_WIDTH       (1)
#define AI_NETWORK_IN_1_SIZE        (1250 * 1 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  (5000)

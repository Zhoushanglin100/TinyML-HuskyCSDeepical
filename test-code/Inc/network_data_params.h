...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 5116, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (5116)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (5116)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 6136, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (6136)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (6136)
